...
## Exercise
<div class="exercise">
We will need the Human reference genome sequence for chromosome 22. Download the repeat-masked (`rm`) version of this sequence to the `ref_data` folder.
...
The general procedure of aligning of our sequencing reads is shown below
